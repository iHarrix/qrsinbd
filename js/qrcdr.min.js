        ...
        var a,
            ...
            h = (function (e, t) {
                (e.locale = e.locale || window.navigator.language),
                    ...
                    (e = De.extend({}, De.spectrum.localization[e.locale], e));
            ...
            ae = te
                ? De(Ke).addClass(c).addClass(h.className).addClass(h.replacerClassName)
                : De([]),
            oe = te ? ae : O,
            ...
            function a(e) {
                return (
                    e.data && e.data.ignore
                        ? (Ae(De(e.target).closest(".sp-thumb-el").data("color")), Fe())
                        : (Ae(De(e.target).closest(".sp-thumb-el").data("color")),
                            Fe(),
                        ...
                        o(e, [
                            {
                                ...
                                value: function () {
                                    ...
                                    (this.image = new Image()),
                                        ...
                                        (this.$image = (0, a.default)("<img />")
                                            .addClass(r.CLASS_NAMES.PREVIEW_IMAGE)
                                            .attr("alt", "")
                                            .css({
                                        ...
                                        this.options.allowDragNDrop &&
                                        a.default.event.props.push("dataTransfer"),
                                        this.bindListeners(),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this.$fileInput.off("change.cropit"),
                                        this.$imageContainer.off(r.EVENTS.PREVIEW),
                                        this.$imageContainer.off(
                                            "dragover.cropit dragleave.cropit drop.cropit"
                                        ),
                                        this.$zoomSlider.off(r.EVENTS.ZOOM_INPUT);
                                },
                            },
                            {
                                key: "onFileChange",
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    e && e.type.match("image")
                                        ? (t.readAsDataURL(e),
                                            (t.onload = this.onFileReaderLoaded.bind(this)),
                                            (t.onerror = this.onFileReaderError.bind(this)))
                                        : e && this.onFileReaderError();
                                },
                            },
                            {
                                        ...
                                        if (
                                            ...
                                            (i.onload = function (e) {
                                                e.target.status >= 300
                                                    ? t.onImageError.call(
                                                        t,
                                                        r.ERRORS.IMAGE_FAILED_TO_LOAD
                                                    )
                                                    : t.loadFile(e.target.response);
                                            }),
                                                i.open("GET", e),
                                                (i.responseType = "blob"),
                                                i.send();
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    if (
                                        ...
                                        return (
                                            this.onImageError(r.ERRORS.SMALL_IMAGE),
                                            void (this.image.src && this.setImageLoadedClass())
                                        );
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    (this.rotation = 0),
                                        ...
                                        this.options.imageState && this.options.imageState.offset
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this.$preview
                                        .removeClass(r.CLASS_NAMES.IMAGE_LOADED)
                                        .addClass(r.CLASS_NAMES.IMAGE_LOADING);
                                },
                            },
                            {
                                ...
                                value: function () {
                                    this.$preview
                                        .removeClass(r.CLASS_NAMES.IMAGE_LOADING)
                                        .addClass(r.CLASS_NAMES.IMAGE_LOADED);
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this.$zoomSlider.attr("disabled", !0),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var e =
                                        ...
                                        this.rotation +
                                        "deg)";
                                    this.$image.css({ transform: e, webkitTransform: e }),
                                        this.options.imageBackground &&
                                        this.$bg.css({ transform: e, webkitTransform: e });
                                },
                            },
                            {
                                key: "rotateCW",
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    if (this.image.src) {
                                        ...
                                        return (
                                            "image/jpeg" === e.type &&
                                            ((n.fillStyle = e.fillBg),
                                                n.fillRect(0, 0, o.width, o.height)),
                                            n.translate(
                                                this.rotatedOffset.x * t,
                                                this.rotatedOffset.y * t
                                            ),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this.unbindListeners(),
                                        this.disableZoomSlider(),
                                        this.$el.addClass(r.CLASS_NAMES.DISABLED);
                                },
                            },
                            {
                                key: "reenable",
                                value: function () {
                                    this.bindListeners(),
                                        this.enableZoomSlider(),
                                        this.$el.removeClass(r.CLASS_NAMES.DISABLED);
                                },
                            },
                            {
                                key: "$",
                                    ...
                                    if (((e = this.fixZoom(e)), this.imageLoaded)) {
                                        var t = this.zoom,
                                            i =
                                                ...
                                                ((this.previewSize.width / 2 - this.offset.x) * e) / t,
                                            o =
                                                this.previewSize.height / 2 -
                                                ((this.previewSize.height / 2 - this.offset.y) * e) / t;
                            ...
                            },
                            {
                                ...
                                set: function (e) {
                                    !e ||
                                        e.width <= 0 ||
                                        e.height <= 0 ||
                                        ((this._previewSize = { width: e.width, height: e.height }),
                                            this.$preview.css({
                    ...
                    i(e, [
                        {
                            ...
                            value: function (e) {
                                var t = e.imageSize,
                                    ...
                                    r = i.width / t.width,
                                    h = i.height / t.height;
                                (this.minZoom = "fit" === a ? Math.min(r, h) : Math.max(r, h)),
                                    "allow" === s && (this.minZoom = Math.min(this.minZoom, 1)),
                                    (this.maxZoom = Math.max(this.minZoom, n / o));
                            },
                        },
                        {
                            key: "getZoom",
                            value: function (e) {
                                return this.minZoom && this.maxZoom
                                    ? e * (this.maxZoom - this.minZoom) + this.minZoom
                                    : null;
                            },
                        },
                        {
                            ...
                            value: function (e) {
                                return this.minZoom && this.maxZoom
                                    ? this.minZoom === this.maxZoom
                                        ? 0
                                        : (e - this.minZoom) / (this.maxZoom - this.minZoom)
                                    : null;
                            },
                        },
                        {
            ...
            var o = i(4),
                n = {
                    elements: [
                        ...
                        return (
                            (e.type = "jQuery element"),
                            (e.default = "$imageCropper.find('" + e.defaultSelector + "')"),
                            e
                        );
                    }),
                    values: [
                    ...
                    callbacks: [
                        ...
                        },
                        {
                            ...
                            params: [
                                { name: "zoom", type: "number", description: "New zoom." },
                            ],
                        },
                        {
                            name: "onOffsetChange",
        ...
        qrcdr: function (options) {
            ...
            return this.each(function () {
                ...
                if (location.hash) {
                    ...
                    section = "#" + hash[1];
                    obj
                        .find('a[data-bs-toggle="tab"][href="' + section + '"]')
                        .tab("show");
                ...
                var validateforms =
                    document.getElementsByClassName("needs-validationNO");
                ...
                if (event.length) {
                    ...
                    document
                        .querySelectorAll(".datetimepicker-input")
